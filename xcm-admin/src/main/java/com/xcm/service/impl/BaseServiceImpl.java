...
import com.xcm.service.BaseService;
...
public class BaseServiceImpl<T, ID extends Serializable> implements BaseService<T, ID> {
	...
	public Page<Object[]> findPage(Pageable pageable, String[] properties) {
		return baseDao.findPage(pageable, properties);
	}

	@Override
	@Transactional(readOnly = true)
	public Page<Map<String, Object>> findPageMap(Pageable pageable, String... properties) {
		return baseDao.findPageMap(pageable, properties);
	}
	...
	@Override
	@Transactional(readOnly = true)
	public List<Object[]> findList(Integer first, Integer count, List<Filter> filters, List<Order> orders,
                                   String[] properties) {
		return baseDao.findList(first, count, filters, orders, properties);
	}
	...
	public List<Map<String, Object>> findListMap(Integer first, Integer count, List<Filter> filters, List<Order> orders, String... properties) {
		return baseDao.findListMap(first, count, filters, orders, properties);
	}
}